...
export default function Page() {
  return (
    <ToolLayout 
      ...
      footerContent={
        <ToolFooter 
          blocks={[
            {
              title: "Upgrade JPG to AVIF",
              description: "Reduce your JPG file sizes even further by converting them to AVIF. Experience superior compression with modern technology.",
              icon: ImageIcon
            },
            {
    ...
    >
      <ImageConverter initialInputFormat="jpg" initialOutputFormat="avif" />
    </ToolLayout>
  );
}
