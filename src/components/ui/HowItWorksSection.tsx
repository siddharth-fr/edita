...
export default function HowItWorksSection({ steps, title, subtitle }: HowItWorksSectionProps) {
    ...
    <section className="w-full max-w-6xl px-4 sm:px-8 py-24 mb-16 mx-auto relative overflow-hidden">
      ...
      <div className="text-center mb-20">
        ...
        <p className="text-lg text-slate-500 max-w-2xl mx-auto">
          {subtitle || "Manage your sensitive files with zero uploads. Everything happens directly in your browser."}
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20">
        {displaySteps.map((item, i) => {
          const itemTheme = item.theme || 'emerald';
          const itemStep = item.step || `0${i + 1}`;
            ...
            <div key={i} className="flex flex-col items-center text-center group">
              ...
              >
                ...
                <div 
                  ...
                  style={{ background: THEME_PALETTE[itemTheme].gradient, filter: 'blur(12px)' }}
                />
